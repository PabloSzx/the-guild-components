...
export const CTA = styled.div(() => [
  ...
  css`
    a {
      ${[
      tw`block w-32 mr-4 px-1.5 py-3 font-medium text-xs text-center text-white bg-light-blue rounded-md no-underline hover:opacity-80`,
