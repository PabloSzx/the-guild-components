...
export const Link = styled.a(({ isActiveLink }: IStyleProps) => [
  ...
  isActiveLink ?
    tw`text-black` : tw`text-gray-500`
]);
...
export const CTA = styled.a(() => [
  tw`flex-none mx-1 px-3 py-3 bg-light-blue font-medium text-xs text-center text-white rounded-md no-underline! hover:opacity-70`,
  tw`md:(mx-0 px-5)`,
  tw`transition duration-200 ease-in-out`,
]);
